...
| `internal/core/move_helpers.go` | 737 | dir-move の外部リンク書き換え（`groupAndApplyExternalRewrites` 経由） |
...
## move_helpers.go 定義ヘルパー（他コマンドから呼び出されるもの）
