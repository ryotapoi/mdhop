...
- [ ] examples skill（`examples/skills/mdhop/`）と README / README.ja を v0.9.0 追加分に同期

## v0.10.0 — frontmatter 検査と search 強化

frontmatter の品質検査と search の強化。v0.9.0 を実 vault に当てた結果（残る phantom、`link_keys` の効き方）を設計判断の材料にする。詳細は [diagnostics.md](diagnostics.md)。
...
- [ ] examples skill と README / README.ja を v0.10.0 追加分に同期
